...
import com.zhilian.hzrf_oa.ui.fragment.DocsendDoneFragment;
import com.zhilian.hzrf_oa.ui.fragment.DocsendTodoFragment;
 ...
 */
public class DocsendManageActivity  extends FragmentActivity implements View.OnClickListener,ViewPager.OnPageChangeListener, OnFragmentInteractionListener {
    private View todoLayout;// 切换到未审批
    private View doneLayout;// 切换到已审批

    private TextView title;//大标题
    private TextView todo;//fragment标题1
    ...
    private void initFragments() {
        mTabs.add(DocsendTodoFragment.newInstance("", ""));
        mTabs.add(DocsendDoneFragment.newInstance("", ""));
