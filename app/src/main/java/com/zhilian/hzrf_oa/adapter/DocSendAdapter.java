...
import com.zhilian.hzrf_oa.json.T_Send;
 ...
 * 发文审批的适配器
 */
public class DocSendAdapter extends BaseAdapter {

    private List<T_Send> list = null;
    private Context mContext;
    private LayoutInflater mInflater;

    public DocSendAdapter(List<T_Send> list, Context context){
        this.list = list;
        mContext = context;
